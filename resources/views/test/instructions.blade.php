...
@section('title', 'Test Instructions - PMA Test Portal')
        ...
        <div class="space-y-6 mb-8">
            <div>
                ...
                <ul class="list-disc list-inside space-y-2 text-gray-700">
                    <li>This test consists of <strong>{{ $testAttempt->testVersion->testSections->count() }} sections</strong></li>
                    <li>Each section contains <strong>{{ $testAttempt->testVersion->questions_per_section }} questions</strong></li>
                    <li>You have <strong>{{ $testAttempt->testVersion->section_time_limit }} minutes</strong> to complete each section</li>
            ...
            <div>
                ...
                <ul class="list-disc list-inside space-y-2 text-gray-700">
                    ...
                    <li><strong>Matching:</strong> Match 4 items from Column A to Column B (all must be correct for marks)</li>
            ...
            <div class="flex justify-center items-center space-x-4 text-sm">
                @foreach($testAttempt->testVersion->testSections as $index => $section)
                    <div class="text-center">
                        <div class="bg-army-green-700 text-white rounded-full w-10 h-10 flex items-center justify-center font-bold mb-1">
                            {{ $index + 1 }}
                        </div>
            ...
            <div class="bg-yellow-50 border border-yellow-300 rounded-lg p-4 mb-6">
                <label class="flex items-start">
                    ...
                    <span class="text-gray-700">
                        I have read and understood all the instructions. I agree to follow all rules and complete the test honestly.
                    </span>
                </label>
            </div>
