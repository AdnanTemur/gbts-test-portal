        ...
        <div class="p-6">
            <div class="space-y-3">
                @foreach($testVersion->testSections as $index => $section)
                    <div class="flex items-center p-4 bg-gradient-to-r from-gray-50 to-white rounded-lg border border-gray-200 hover:border-army-green-300 transition-colors">
                        <div class="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-army-green-700 to-army-green-600 text-white rounded-lg flex items-center justify-center font-bold shadow-sm mr-4">
                            {{ $index + 1 }}
                        </div>
                        <div class="flex-1">
