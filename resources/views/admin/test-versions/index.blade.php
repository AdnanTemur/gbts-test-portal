            ...
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900">
                        {{ \App\Models\TestVersion::where('status', 'active')->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-5">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900">
                        {{ \App\Models\TestVersion::where('status', 'draft')->count() }}</p>
                </div>
            </div>
        </div>
                    ...
                    @forelse($versions as $version)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div
                                                class="flex-shrink-0 h-10 w-10 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-lg flex items-center justify-center">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="space-y-1">
                                            <div class="flex items-center text-xs text-gray-600">
                                                ...
                                                <span
                                                    class="font-medium">{{ $version->testSections->sum(fn($s) => $s->pivot->questions_per_section) }}</span>
                                                total questions
                                            </div>
                                            <div class="flex items-center text-xs text-gray-600">
                                                <svg class="w-3 h-3 mr-1.5 text-gray-400" fill="none" stroke="currentColor"
                                                ...
                                                <span
                                                    class="font-medium">{{ $version->testSections->sum(fn($s) => $s->pivot->time_limit ?? 0) }}</span>
                                                min total
                                            </div>
                                            <div class="flex items-center text-xs text-gray-600">
                                                <svg class="w-3 h-3 mr-1.5 text-gray-400" fill="none" stroke="currentColor"
                        ...
                        <span
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex items-center justify-end gap-2">
                                            ...
                                            <form action="{{ route('admin.test-versions.destroy', $version) }}" method="POST"
                                                class="inline">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
